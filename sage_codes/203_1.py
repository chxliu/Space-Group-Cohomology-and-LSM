...
def RandPT(PTtuple3):
    ...
    singt = np.array([1,p1,p2,p3,p1*p2,p2*p3,cp1,cp1*p1,cp1*p2,cp1*p3,cp1*p1*p2,cp1*p2*p3,cp2,cp2*p1,cp2*p2,cp2*p3,cp2*p1*p2,cp2*p2*p3,cp3,cp3*p1,cp3*p2,cp3*p3,cp3*p1*p2,cp3*p2*p3,cp1*cp2,cp1*cp2*p1,cp1*cp2*p2,cp1*cp2*p3,cp1*cp2*p1*p2,cp1*cp2*p2*p3,cp1*cp3,cp1*cp3*p1,cp1*cp3*p2,cp1*cp3*p3,cp1*cp3*p1*p2,cp1*cp3*p2*p3,cp2*cp3,cp2*cp3*p1,cp2*cp3*p2,cp2*cp3*p3,cp2*cp3*p1*p2,cp2*cp3*p2*p3,c1,c1*p1,c1*p2,c1*p3,c1*p1*p2,c1*p2*p3,c1*cp1,c1*cp1*p1,c1*cp1*p2,c1*cp1*p3,c1*cp1*p1*p2,c1*cp1*p2*p3,c1*cp2,c1*cp2*p1,c1*cp2*p2,c1*cp2*p3,c1*cp2*p1*p2,c1*cp2*p2*p3,c1*cp3,c1*cp3*p1,c1*cp3*p2,c1*cp3*p3,c1*cp3*p1*p2,c1*cp3*p2*p3,c1*cp1*cp2,c1*cp1*cp2*p1,c1*cp1*cp2*p2,c1*cp1*cp2*p3,c1*cp1*cp2*p1*p2,c1*cp1*cp2*p2*p3,c1*cp1*cp3,c1*cp1*cp3*p1,c1*cp1*cp3*p2,c1*cp1*cp3*p3,c1*cp1*cp3*p1*p2,c1*cp1*cp3*p2*p3,c1*cp2*cp3,c1*cp2*cp3*p1,c1*cp2*cp3*p2,c1*cp2*cp3*p3,c1*cp2*cp3*p1*p2,c1*cp2*cp3*p2*p3,c2,c2*p1,c2*p2,c2*p3,c2*p1*p2,c2*p2*p3,c2*cp1,c2*cp1*p1,c2*cp1*p2,c2*cp1*p3,c2*cp1*p1*p2,c2*cp1*p2*p3,c2*cp2,c2*cp2*p1,c2*cp2*p2,c2*cp2*p3,c2*cp2*p1*p2,c2*cp2*p2*p3,c2*cp3,c2*cp3*p1,c2*cp3*p2,c2*cp3*p3,c2*cp3*p1*p2,c2*cp3*p2*p3,c2*cp1*cp2,c2*cp1*cp2*p1,c2*cp1*cp2*p2,c2*cp1*cp2*p3,c2*cp1*cp2*p1*p2,c2*cp1*cp2*p2*p3,c2*cp1*cp3,c2*cp1*cp3*p1,c2*cp1*cp3*p2,c2*cp1*cp3*p3,c2*cp1*cp3*p1*p2,c2*cp1*cp3*p2*p3,c2*cp2*cp3,c2*cp2*cp3*p1,c2*cp2*cp3*p2,c2*cp2*cp3*p3,c2*cp2*cp3*p1*p2,c2*cp2*cp3*p2*p3,c3,c3*p1,c3*p2,c3*p3,c3*p1*p2,c3*p2*p3,c3*cp1,c3*cp1*p1,c3*cp1*p2,c3*cp1*p3,c3*cp1*p1*p2,c3*cp1*p2*p3,c3*cp2,c3*cp2*p1,c3*cp2*p2,c3*cp2*p3,c3*cp2*p1*p2,c3*cp2*p2*p3,c3*cp3,c3*cp3*p1,c3*cp3*p2,c3*cp3*p3,c3*cp3*p1*p2,c3*cp3*p2*p3,c3*cp1*cp2,c3*cp1*cp2*p1,c3*cp1*cp2*p2,c3*cp1*cp2*p3,c3*cp1*cp2*p1*p2,c3*cp1*cp2*p2*p3,c3*cp1*cp3,c3*cp1*cp3*p1,c3*cp1*cp3*p2,c3*cp1*cp3*p3,c3*cp1*cp3*p1*p2,c3*cp1*cp3*p2*p3,c3*cp2*cp3,c3*cp2*cp3*p1,c3*cp2*cp3*p2,c3*cp2*cp3*p3,c3*cp2*cp3*p1*p2,c3*cp2*cp3*p2*p3,c1*c2,c1*c2*p1,c1*c2*p2,c1*c2*p3,c1*c2*p1*p2,c1*c2*p2*p3,c1*c2*cp1,c1*c2*cp1*p1,c1*c2*cp1*p2,c1*c2*cp1*p3,c1*c2*cp1*p1*p2,c1*c2*cp1*p2*p3,c1*c2*cp2,c1*c2*cp2*p1,c1*c2*cp2*p2,c1*c2*cp2*p3,c1*c2*cp2*p1*p2,c1*c2*cp2*p2*p3,c1*c2*cp3,c1*c2*cp3*p1,c1*c2*cp3*p2,c1*c2*cp3*p3,c1*c2*cp3*p1*p2,c1*c2*cp3*p2*p3,c1*c2*cp1*cp2,c1*c2*cp1*cp2*p1,c1*c2*cp1*cp2*p2,c1*c2*cp1*cp2*p3,c1*c2*cp1*cp2*p1*p2,c1*c2*cp1*cp2*p2*p3,c1*c2*cp1*cp3,c1*c2*cp1*cp3*p1,c1*c2*cp1*cp3*p2,c1*c2*cp1*cp3*p3,c1*c2*cp1*cp3*p1*p2,c1*c2*cp1*cp3*p2*p3,c1*c2*cp2*cp3,c1*c2*cp2*cp3*p1,c1*c2*cp2*cp3*p2,c1*c2*cp2*cp3*p3,c1*c2*cp2*cp3*p1*p2,c1*c2*cp2*cp3*p2*p3,c2*c3,c2*c3*p1,c2*c3*p2,c2*c3*p3,c2*c3*p1*p2,c2*c3*p2*p3,c2*c3*cp1,c2*c3*cp1*p1,c2*c3*cp1*p2,c2*c3*cp1*p3,c2*c3*cp1*p1*p2,c2*c3*cp1*p2*p3,c2*c3*cp2,c2*c3*cp2*p1,c2*c3*cp2*p2,c2*c3*cp2*p3,c2*c3*cp2*p1*p2,c2*c3*cp2*p2*p3,c2*c3*cp3,c2*c3*cp3*p1,c2*c3*cp3*p2,c2*c3*cp3*p3,c2*c3*cp3*p1*p2,c2*c3*cp3*p2*p3,c2*c3*cp1*cp2,c2*c3*cp1*cp2*p1,c2*c3*cp1*cp2*p2,c2*c3*cp1*cp2*p3,c2*c3*cp1*cp2*p1*p2,c2*c3*cp1*cp2*p2*p3,c2*c3*cp1*cp3,c2*c3*cp1*cp3*p1,c2*c3*cp1*cp3*p2,c2*c3*cp1*cp3*p3,c2*c3*cp1*cp3*p1*p2,c2*c3*cp1*cp3*p2*p3,c2*c3*cp2*cp3,c2*c3*cp2*cp3*p1,c2*c3*cp2*cp3*p2,c2*c3*cp2*cp3*p3,c2*c3*cp2*cp3*p1*p2,c2*c3*cp2*cp3*p2*p3],dtype=int)
...
MM = np.array([randdiffGen() for _ in range(128000)],dtype=int)
#MM = np.vstack(MM)
MM = MM%2
