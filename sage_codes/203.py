...
def RandXYZ(XYZtuple3):
    ...
    return np.array([1,x1,y1,z1,x2,y2,z2,x3,y3,z3,1/2*x1*(1+x1),1/2*y1*(1+y1),1/2*z1*(1+z1),1/2*x2*(1+x2),1/2*y2*(1+y2),1/2*z2*(1+z2),1/2*x3*(1+x3),1/2*y3*(1+y3),1/2*z3*(1+z3),x1*y1,x1*z1,x1*x2,x1*y2,x1*z2,x1*x3,x1*y3,x1*z3,y1*z1,x2*y1,y1*y2,y1*z2,x3*y1,y1*y3,y1*z3,x2*z1,y2*z1,z1*z2,x3*z1,y3*z1,z1*z3,x2*y2,x2*z2,x2*x3,x2*y3,x2*z3,y2*z2],dtype=int)

def RandPT(PTtuple3):
    c1,c2,c3,cp1,cp2,cp3,t1,t2,t3,p1,p2,p3 = PTtuple3
    singt = np.array([1,p1,p2,p3,p1*p2,cp1,cp1*p1,cp1*p2,cp1*p3,cp1*p1*p2,cp2,cp2*p1,cp2*p2,cp2*p3,cp2*p1*p2,cp3,cp3*p1,cp3*p2,cp3*p3,cp3*p1*p2,cp1*cp2,cp1*cp2*p1,cp1*cp2*p2,cp1*cp2*p3,cp1*cp2*p1*p2,cp1*cp3,cp1*cp3*p1,cp1*cp3*p2,cp1*cp3*p3,cp1*cp3*p1*p2,cp2*cp3,cp2*cp3*p1,cp2*cp3*p2,cp2*cp3*p3,cp2*cp3*p1*p2,cp1*cp2*cp3,cp1*cp2*cp3*p1,cp1*cp2*cp3*p2,cp1*cp2*cp3*p3,cp1*cp2*cp3*p1*p2,c1,c1*p1,c1*p2,c1*p3,c1*p1*p2,c1*cp1,c1*cp1*p1,c1*cp1*p2,c1*cp1*p3,c1*cp1*p1*p2,c1*cp2,c1*cp2*p1,c1*cp2*p2,c1*cp2*p3,c1*cp2*p1*p2,c1*cp3,c1*cp3*p1,c1*cp3*p2,c1*cp3*p3,c1*cp3*p1*p2,c1*cp1*cp2,c1*cp1*cp2*p1,c1*cp1*cp2*p2,c1*cp1*cp2*p3,c1*cp1*cp2*p1*p2,c1*cp1*cp3,c1*cp1*cp3*p1,c1*cp1*cp3*p2,c1*cp1*cp3*p3,c1*cp1*cp3*p1*p2,c1*cp2*cp3,c1*cp2*cp3*p1,c1*cp2*cp3*p2,c1*cp2*cp3*p3,c1*cp2*cp3*p1*p2,c1*cp1*cp2*cp3,c1*cp1*cp2*cp3*p1,c1*cp1*cp2*cp3*p2,c1*cp1*cp2*cp3*p3,c1*cp1*cp2*cp3*p1*p2,c2,c2*p1,c2*p2,c2*p3,c2*p1*p2,c2*cp1,c2*cp1*p1,c2*cp1*p2,c2*cp1*p3,c2*cp1*p1*p2,c2*cp2,c2*cp2*p1,c2*cp2*p2,c2*cp2*p3,c2*cp2*p1*p2,c2*cp3,c2*cp3*p1,c2*cp3*p2,c2*cp3*p3,c2*cp3*p1*p2,c2*cp1*cp2,c2*cp1*cp2*p1,c2*cp1*cp2*p2,c2*cp1*cp2*p3,c2*cp1*cp2*p1*p2,c2*cp1*cp3,c2*cp1*cp3*p1,c2*cp1*cp3*p2,c2*cp1*cp3*p3,c2*cp1*cp3*p1*p2,c2*cp2*cp3,c2*cp2*cp3*p1,c2*cp2*cp3*p2,c2*cp2*cp3*p3,c2*cp2*cp3*p1*p2,c2*cp1*cp2*cp3,c2*cp1*cp2*cp3*p1,c2*cp1*cp2*cp3*p2,c2*cp1*cp2*cp3*p3,c2*cp1*cp2*cp3*p1*p2,c3,c3*p1,c3*p2,c3*p3,c3*p1*p2,c3*cp1,c3*cp1*p1,c3*cp1*p2,c3*cp1*p3,c3*cp1*p1*p2,c3*cp2,c3*cp2*p1,c3*cp2*p2,c3*cp2*p3,c3*cp2*p1*p2,c3*cp3,c3*cp3*p1,c3*cp3*p2,c3*cp3*p3,c3*cp3*p1*p2,c3*cp1*cp2,c3*cp1*cp2*p1,c3*cp1*cp2*p2,c3*cp1*cp2*p3,c3*cp1*cp2*p1*p2,c3*cp1*cp3,c3*cp1*cp3*p1,c3*cp1*cp3*p2,c3*cp1*cp3*p3,c3*cp1*cp3*p1*p2,c3*cp2*cp3,c3*cp2*cp3*p1,c3*cp2*cp3*p2,c3*cp2*cp3*p3,c3*cp2*cp3*p1*p2,c3*cp1*cp2*cp3,c3*cp1*cp2*cp3*p1,c3*cp1*cp2*cp3*p2,c3*cp1*cp2*cp3*p3,c3*cp1*cp2*cp3*p1*p2,c1*c2,c1*c2*p1,c1*c2*p2,c1*c2*p3,c1*c2*p1*p2,c1*c2*cp1,c1*c2*cp1*p1,c1*c2*cp1*p2,c1*c2*cp1*p3,c1*c2*cp1*p1*p2,c1*c2*cp2,c1*c2*cp2*p1,c1*c2*cp2*p2,c1*c2*cp2*p3,c1*c2*cp2*p1*p2,c1*c2*cp3,c1*c2*cp3*p1,c1*c2*cp3*p2,c1*c2*cp3*p3,c1*c2*cp3*p1*p2,c1*c2*cp1*cp2,c1*c2*cp1*cp2*p1,c1*c2*cp1*cp2*p2,c1*c2*cp1*cp2*p3,c1*c2*cp1*cp2*p1*p2,c1*c2*cp1*cp3,c1*c2*cp1*cp3*p1,c1*c2*cp1*cp3*p2,c1*c2*cp1*cp3*p3,c1*c2*cp1*cp3*p1*p2,c1*c2*cp2*cp3,c1*c2*cp2*cp3*p1,c1*c2*cp2*cp3*p2,c1*c2*cp2*cp3*p3,c1*c2*cp2*cp3*p1*p2,c1*c2*cp1*cp2*cp3,c1*c2*cp1*cp2*cp3*p1,c1*c2*cp1*cp2*cp3*p2,c1*c2*cp1*cp2*cp3*p3,c1*c2*cp1*cp2*cp3*p1*p2,c1*c3,c1*c3*p1,c1*c3*p2,c1*c3*p3,c1*c3*p1*p2,c1*c3*cp1,c1*c3*cp1*p1,c1*c3*cp1*p2,c1*c3*cp1*p3,c1*c3*cp1*p1*p2,c1*c3*cp2,c1*c3*cp2*p1,c1*c3*cp2*p2,c1*c3*cp2*p3,c1*c3*cp2*p1*p2,c1*c3*cp3,c1*c3*cp3*p1,c1*c3*cp3*p2,c1*c3*cp3*p3,c1*c3*cp3*p1*p2,c1*c3*cp1*cp2,c1*c3*cp1*cp2*p1,c1*c3*cp1*cp2*p2,c1*c3*cp1*cp2*p3,c1*c3*cp1*cp2*p1*p2,c1*c3*cp1*cp3,c1*c3*cp1*cp3*p1,c1*c3*cp1*cp3*p2,c1*c3*cp1*cp3*p3,c1*c3*cp1*cp3*p1*p2,c1*c3*cp2*cp3,c1*c3*cp2*cp3*p1,c1*c3*cp2*cp3*p2,c1*c3*cp2*cp3*p3,c1*c3*cp2*cp3*p1*p2,c1*c3*cp1*cp2*cp3,c1*c3*cp1*cp2*cp3*p1,c1*c3*cp1*cp2*cp3*p2,c1*c3*cp1*cp2*cp3*p3,c1*c3*cp1*cp2*cp3*p1*p2,c2*c3,c2*c3*p1,c2*c3*p2,c2*c3*p3,c2*c3*p1*p2,c2*c3*cp1,c2*c3*cp1*p1,c2*c3*cp1*p2,c2*c3*cp1*p3,c2*c3*cp1*p1*p2,c2*c3*cp2,c2*c3*cp2*p1,c2*c3*cp2*p2,c2*c3*cp2*p3,c2*c3*cp2*p1*p2,c2*c3*cp3,c2*c3*cp3*p1,c2*c3*cp3*p2,c2*c3*cp3*p3,c2*c3*cp3*p1*p2,c2*c3*cp1*cp2,c2*c3*cp1*cp2*p1,c2*c3*cp1*cp2*p2,c2*c3*cp1*cp2*p3,c2*c3*cp1*cp2*p1*p2,c2*c3*cp1*cp3,c2*c3*cp1*cp3*p1,c2*c3*cp1*cp3*p2,c2*c3*cp1*cp3*p3,c2*c3*cp1*cp3*p1*p2,c2*c3*cp2*cp3,c2*c3*cp2*cp3*p1,c2*c3*cp2*cp3*p2,c2*c3*cp2*cp3*p3,c2*c3*cp2*cp3*p1*p2,c2*c3*cp1*cp2*cp3,c2*c3*cp1*cp2*cp3*p1,c2*c3*cp1*cp2*cp3*p2,c2*c3*cp1*cp2*cp3*p3,c2*c3*cp1*cp2*cp3*p1*p2,c1*c2*c3,c1*c2*c3*p1,c1*c2*c3*p2,c1*c2*c3*p3,c1*c2*c3*p1*p2,c1*c2*c3*cp1,c1*c2*c3*cp1*p1,c1*c2*c3*cp1*p2,c1*c2*c3*cp1*p3,c1*c2*c3*cp1*p1*p2,c1*c2*c3*cp2,c1*c2*c3*cp2*p1,c1*c2*c3*cp2*p2,c1*c2*c3*cp2*p3,c1*c2*c3*cp2*p1*p2,c1*c2*c3*cp3,c1*c2*c3*cp3*p1,c1*c2*c3*cp3*p2,c1*c2*c3*cp3*p3,c1*c2*c3*cp3*p1*p2,c1*c2*c3*cp1*cp2,c1*c2*c3*cp1*cp2*p1,c1*c2*c3*cp1*cp2*p2,c1*c2*c3*cp1*cp2*p3,c1*c2*c3*cp1*cp2*p1*p2,c1*c2*c3*cp1*cp3,c1*c2*c3*cp1*cp3*p1,c1*c2*c3*cp1*cp3*p2,c1*c2*c3*cp1*cp3*p3,c1*c2*c3*cp1*cp3*p1*p2,c1*c2*c3*cp2*cp3,c1*c2*c3*cp2*cp3*p1,c1*c2*c3*cp2*cp3*p2,c1*c2*c3*cp2*cp3*p3,c1*c2*c3*cp2*cp3*p1*p2,c1*c2*c3*cp1*cp2*cp3,c1*c2*c3*cp1*cp2*cp3*p1,c1*c2*c3*cp1*cp2*cp3*p2,c1*c2*c3*cp1*cp2*cp3*p3,c1*c2*c3*cp1*cp2*cp3*p1*p2],dtype=int)
...
MM = np.array([randdiffGen() for _ in range(135000)],dtype=int)
#MM = np.vstack(MM)
MM = MM%2
